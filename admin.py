...
from config import is_admin_in_chat, TRIGGER_NAMES, MOOD_NAMES, TRIGGER_EMOJI, MOOD_EMOJI, TRIGGER_SYMBOLS, MOOD_SYMBOLS
...
async def cmd_admin(message: Message):
    if not await is_admin_in_chat(message.from_user.id, message.bot):
        return await message.answer("❌ Ты не в админском чате.")
