...
from config import TRIGGER_NAMES, MOOD_NAMES, TRIGGER_EMOJI, MOOD_EMOJI, TRIGGER_SYMBOLS, MOOD_SYMBOLS
...
# ============================================================
# 0. ТЕСТОВАЯ КОМАНДА ДЛЯ ПРОВЕРКИ
# ============================================================
...
async def handle_phrase_input(message: Message):
    """Принимает фразу от пользователя (только если не команда)"""
