...
# Убираем мусорные логи aiogram.event
...
async def on_startup(bot: Bot):
    ...
    # Папки создаются только один раз — при первом запуске
    # Закомментировано для ускорения деплоя
...
async def main():
    ...
    # ============================================================
    # РЕГИСТРАЦИЯ ХЕНДЛЕРОВ (ТЕПЕРЬ ТОЛЬКО ОДНА!)
    # ============================================================
